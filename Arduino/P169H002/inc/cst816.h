...
#define TOUCH_RST_PIN    13U    // Reset pin
#define TOUCH_INT_PIN    9U    // Interrupt pin

#define I2C0_SDA_PIN        11U
#define I2C0_SCL_PIN        10U
/* Function macros */
#define TOUCH_RST_0 digitalWrite(TOUCH_RST_PIN, LOW)
#define TOUCH_RST_1 digitalWrite(TOUCH_RST_PIN, HIGH)
