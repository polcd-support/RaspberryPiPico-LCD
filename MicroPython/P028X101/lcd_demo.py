...
def lcd_demo():
    ...
    while True:
        ...
        if g_state == STATE_LOGO:
            ...
            if ft6236.get_touch_count()>0:
                if lastX != 0xFFFF and lastY != 0xFFFF:
                    lcd.LCD_DrawThickLine(lastX, lastY, ft6236.X_Pos, ft6236.Y_Pos, WHITE,2)
                lastX = ft6236.X_Pos
                lastY = ft6236.Y_Pos
